...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, img_options=None, target_transform=None):
        ...
        degarded_files = sorted(os.listdir(rgb_dir))

        self.degarded_filenames = [os.path.join(rgb_dir, x) for x in degarded_files if is_png_file(x)]
    ...
    def __getitem__(self, index):
        ...
        return degarded, degarded_filename,idx,degarded_mem
...
class DataLoaderVal(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        self.degarded_filenames = [os.path.join(rgb_dir, x) for x in degarded_files if is_image_file(x)]


        self.tar_size = len(self.degarded_filenames)
        self.norm = t.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
    ...
    def __getitem__(self, index):
        ...
        return degarded, degarded_filename,idx,degarded__mem
...
class DataLoaderVal_pic(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return degarded, degarded_filename,idx,degarded__mem,output
